...
from tests.server_side.helper_server import h_register_dummy_user_device, h_mock_get_client_id
...
class TestFolders(unittest.TestCase):
    ...
    def test_create_physical_folder(self):
        ...
        expected = os.path.join(path_utils.get_users_root_folder(self.user.user_id), folder_name)
